...
- Cung cấp **hàng trăm phòng trọ đã được xác thực** trên cả nước
...
│   ├── auth/                  │  Giao diện quên mật khẩu, xác thực danh tính
...
| **Môi giới** (`agent`)        | Tất cả quyền trên + đăng và quản lý tin phòng _(cần xác thực danh tính khi đăng ký)_  |
| **Bên cho thuê** (`landlord`) | Tương tự Môi giới — dành cho chủ nhà trực tiếp _(cần xác thực danh tính khi đăng ký)_ |
