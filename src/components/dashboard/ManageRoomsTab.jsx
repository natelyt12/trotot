                        ...
                        <div className="space-y-4">
                            {filteredRooms.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE).map((room) => {
                                ...
                                return (
                                    <div
                                        key={room.id}
                                        className="flex flex-col p-4 border border-stone-100 rounded-xl hover:border-amber-300 transition-all bg-white group gap-3"
                                    >
                                        {/* Nội dung bên trên */}
                                        ...
                                        <div className="flex flex-wrap items-center justify-between gap-2 border-t border-stone-100 pt-3">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                <span
                                                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-[0.65rem] font-bold uppercase ${
                                                        isExpired
                                    ...
                                    {(() => {
                                        ...
                                        return pages.map((pageNum) => (
                                            <button
                                                ...
                                                className={`w-8 h-8 flex items-center justify-center rounded-full border text-sm font-bold transition-colors cursor-pointer ${
                                                    currentPage === pageNum
