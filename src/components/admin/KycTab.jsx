    ...
    return (
        <div className="space-y-6">
            ...
            {kycRequests.length === 0 ? (
                ...
                <div className="space-y-6">
                    {kycRequests.map((req) => (
                        <div key={req.id} className="border border-stone-200 rounded-2xl p-6 bg-white space-y-5 hover:shadow-md transition-all duration-200">
                            {/* User Info card */}
