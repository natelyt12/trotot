    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h3 className="text-xl font-semibold text-stone-900 font-heading">Quản lý Mock Data</h3>
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2.5 border border-stone-200 rounded-xl text-xs font-medium text-stone-500 hover:bg-stone-50 hover:text-stone-800 cursor-pointer transition-colors"
                    >
                        <TbRefresh size={14} />
                        <span>Làm mới</span>
                    </button>
                    <button
                        ...
                        className="bg-red-50 hover:bg-red-100 text-red-600 px-5 py-2.5 rounded-xl text-xs font-medium border border-red-100 cursor-pointer transition-colors flex items-center gap-1.5"
                    >
                        <TbTrash size={16} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="bg-stone-50 border border-stone-200 rounded-2xl p-5">
                    <div className="text-stone-400 text-xs font-medium uppercase mb-2">Dummy Rooms</div>
                    <div className="text-2xl font-bold text-stone-900 font-heading">{mockStats.mockRooms}</div>
                    <div className="text-[10px] text-stone-400 font-normal mt-1">Tin đăng trọ giả lập (chứa mã TT-MOCK) được gán cho Admin</div>
                </div>
                <div className="bg-stone-50 border border-stone-200 rounded-2xl p-5">
                    <div className="text-stone-400 text-xs font-medium uppercase mb-2">Trạng thái Mock Data</div>
                    <div className="text-sm font-semibold text-amber-600 font-heading flex items-center gap-1.5 mt-2">
                    ...
                    <div className="text-[10px] text-stone-400 font-normal mt-1">Hỗ trợ dọn dẹp mock data tự động không ảnh hưởng dữ liệu thật</div>
                </div>
            </div>

            {/* Scenario Selection Grid */}
            <div className="space-y-4">
                <h4 className="text-sm font-semibold text-stone-900 uppercase tracking-wider">Kịch bản Test (Cộng dồn)</h4>
                            ...
                            <div key={scenario.id} className="bg-white border border-stone-200 rounded-2xl p-5 hover:shadow-md transition-all duration-200 flex flex-col justify-between space-y-4">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <h5 className="font-semibold text-stone-900 text-sm font-heading">{scenario.title}</h5>
                                    </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-stone-900 hover:bg-stone-800 text-white font-medium text-xs py-2 rounded-xl border-none cursor-pointer transition-colors"
                                >
                                    Kích hoạt kịch bản
                                </button>
                            </div>
