            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="flex items-center gap-1.5 px-4 py-2 bg-white border border-stone-200 rounded-xl text-xs font-bold text-stone-600 hover:bg-stone-50 hover:text-stone-900 hover:border-stone-300 transition-colors shadow-xs cursor-pointer disabled:opacity-50"
                        >
                            <TbRefresh size={14} className={loadingRented ? "animate-spin" : ""} />
                            <span>Làm mới</span>
                        </button>
                        {loadingRented ? (
                            <div className="bg-stone-100 text-stone-400 px-4 py-1.5 rounded-full text-xs font-bold border border-stone-200 w-fit flex items-center gap-1.5 animate-pulse">
                            ...
                            <div className="bg-stone-500/10 text-stone-600 px-4 py-1.5 rounded-full text-xs font-bold border border-stone-500/20 w-fit flex items-center gap-1.5">
                ...
                <div className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
                    <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] items-stretch min-h-[500px]">
                        {/* Sidebar */}
                        <aside className="lg:border-r border-stone-100 bg-stone-50/30 p-6 flex flex-col gap-6">
                            <div className="space-y-2">
                                <div className="px-3 py-1 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Quản lý</div>
                                    ...
                                    <div>
                                        {loadingRented ? (
                                            ...
                                            <div className="text-center py-20 bg-white border border-dashed border-stone-200 rounded-2xl">
                                                ...
                                                <p className="font-bold text-stone-700 mb-1 text-base">Bạn chưa có phòng đang thuê nào</p>
                                                ...
                                                <button
                                                    onClick={() => navigate("home")}
                                                    className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-bold text-sm px-6 py-2.5 rounded-xl border-none cursor-pointer transition-colors shadow-sm"
                                                >
                                                    <TbPlus size={16} />
                                                    Tìm phòng trọ
                                                </button>
                                                ...
                                                {rentedRooms.map((rr) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="p-5">
                                                                <h3 className="font-bold text-stone-900 text-base line-clamp-2 mb-1">{room.title}</h3>
                                                                ...
                                                                {landlord && (
                                                                    <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-xl mb-4">
                                                                        <div
                                                                            className="w-9 h-9 rounded-full bg-amber-500 text-white flex items-center justify-center font-bold text-sm shrink-0 overflow-hidden"
                                                                            style={
                                                                                landlord.avatar_url
                                                                                    ? {
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                            <div className="text-[10px] text-stone-400 font-bold uppercase">Chủ nhà</div>
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    <button
                                                                        ...
                                                                        className="flex flex-1 items-center justify-center gap-1.5 py-2 border border-stone-200 text-stone-700 text-xs font-bold rounded-xl hover:bg-stone-50 cursor-pointer transition-colors"
                                                                    >
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-stone-100 pb-5 mb-6 gap-4">
                                            <div>
                                                ...
                                                <p className="text-stone-500 text-xs mt-0.5">
                                                    Mã hợp đồng điện tử:{" "}
                                                    <span className="font-mono font-bold text-stone-700">{mockContractData.contractId}</span>
                                                </p>
                                            </div>
                                                ...
                                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-stone-100 pb-4 gap-3">
                                                    <div>
                                                        ...
                                                        <p className="text-[11px] text-stone-500 mt-0.5">
                                                            Mã hóa đơn: <span className="font-mono text-stone-700 font-bold">{payment.invoiceId}</span>
                                                        </p>
                                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        {loadingRequests ? (
                                            ...
                                            <div className="text-center py-20 bg-white border border-dashed border-stone-200 rounded-2xl">
                                                ...
                                                <p className="font-bold text-stone-700 mb-1 text-base">Bạn chưa có yêu cầu chuyển nhượng nào</p>
                                                <p className="text-stone-400 text-sm mb-6 max-w-xs mx-auto">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1 min-w-0 pl-2">
                                                            <div className="flex items-center gap-2 mb-3">
                                                                <span className="px-2.5 py-1 bg-purple-100 text-purple-700 text-[0.65rem] font-bold rounded-full uppercase tracking-wider">
                                                                    Yêu cầu xin sang nhượng
                                                                </span>
                                                            </div>

                                                            <h3 className="font-bold text-stone-900 text-base line-clamp-1 mb-1">
                                                            ...
                                                            <div className="flex items-center gap-3 mt-4">
                                                                <div className="flex items-center gap-2 bg-stone-50 px-3 py-2 rounded-xl border border-stone-200 flex-1 min-w-0">
                                                                    <div
                                                                        className="w-8 h-8 rounded-full bg-stone-200 flex items-center justify-center font-bold text-xs shrink-0 overflow-hidden"
                                                                        style={
                                                                    ...
                                                                    <div className="min-w-0">
                                                                        <div className="text-[0.65rem] font-bold text-stone-400 uppercase">Người xin nhận</div>
                                                                        <div className="text-sm font-bold text-stone-800 truncate">
                                                        ...
                                                        <div className="flex md:flex-col gap-3 justify-center items-center md:items-end md:w-36 shrink-0 md:border-l md:border-stone-100 md:pl-6">
                                                            <button
                                                                ...
                                                                className="w-full flex items-center justify-center gap-1.5 px-4 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-xl font-bold text-sm transition-colors border-none cursor-pointer shadow-sm"
                                                            >
                                                                <TbCheck size={16} /> Duyệt
                                                            </button>
                                                            <button
                                                                onClick={() => handleRejectRequest(request)}
                                                                className="w-full flex items-center justify-center gap-1.5 px-4 py-2.5 bg-stone-100 hover:bg-stone-200 text-stone-600 rounded-xl font-bold text-sm transition-colors border-none cursor-pointer"
                                                            >
