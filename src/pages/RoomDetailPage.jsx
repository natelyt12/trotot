  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fafaf9', paddingTop: '80px' }}>
      <div className="container-app" style={{ paddingTop: '1.5rem', paddingBottom: '3rem' }}>
        ...
        {/* Breadcrumb */}
        <nav style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.25rem', fontSize: '0.85rem', color: '#78716c' }}>
          <button onClick={() => navigate('home')} style={{ background: 'none', border: 'none', color: '#d97706', cursor: 'pointer', fontWeight: 600, fontFamily: 'Inter, sans-serif', padding: 0, transition: 'color 0.2s' }}
          ...
          <ChevronRight />
          <span style={{ color: '#a8a29e' }}>{basic_info.city || 'Danh sách phòng'}</span>
          <ChevronRight />
          <span style={{ color: '#1c1917', fontWeight: 500 }}>{basic_info.title}</span>
        </nav>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 340px', gap: '2rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', position: 'sticky', top: '88px' }}>
            ...
            >
              <div style={{ fontFamily: 'var(--font-heading)', fontSize: '2rem', fontWeight: 800, color: '#fcd34d', letterSpacing: '-0.02em' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <button
                  ...
                  style={{ width: '100%', justifyContent: 'center', padding: '0.75rem', color: '#fcd34d', borderColor: 'rgba(252,211,77,0.4)' }}
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="card" style={{ padding: '1.25rem' }}>
              <h3 style={{ fontFamily: 'var(--font-heading)', fontSize: '0.95rem', fontWeight: 700, marginBottom: '0.875rem' }}>Thông tin chủ trọ</h3>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem' }}>
                ...
                >
                  <span style={{ color: '#fff', fontWeight: 700, fontSize: '1.1rem', fontFamily: 'var(--font-heading)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span className={`badge ${media_contact.contact.role === 'landlord' ? 'badge-amber' : 'badge-blue'}`} style={{ fontSize: '0.72rem' }}>
