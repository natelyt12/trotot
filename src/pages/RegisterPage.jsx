                ...
                <div className="bg-white rounded-xl p-8 border border-stone-200">
                    ...
                    {step === 1 ? (
                        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3.5">
                            {errors.server && <div className="bg-red-50 text-red-600 p-3 rounded-lg border border-red-200 text-sm">{errors.server}</div>}
                        ...
                        <VerificationForm role={form.role} loading={loading} onBack={() => setStep(1)} onSubmit={handleSubmit} />
                    )}
